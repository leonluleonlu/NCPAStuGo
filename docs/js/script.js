...
!(function(c) {
  ...
  function u(e, t, n, o) {
    ...
    else (a = o || "au-accordion--open"), (i = n || "au-accordion--closed");
    var l, r, c, s;
    (s = a),
      (c = e).classList
      ...
      for (var n = 0; n < e.length; n++) {
        ...
        (o =
          "undefined" != typeof getComputedStyle
            ? window.getComputedStyle(l).height
            : l.currentStyle.height),
          0 === parseInt(o) && (l.style.height = "0px"),
          (l.style.display = ""),
          u(l, "opening"),
          u(a, "opening"),
          s(a, 0, "opening"),
...
!(function(f) {
  ...
  function s(e, t, n) {
    ...
    return (
      (a = n / l),
      Math.abs(a) < 1e3 / 60 &&
        ((a = 1e3 / 60), (i = o / (l = Math.ceil(Math.abs(n / a))))),
      { stepSize: i, steps: l - 1, intervalTime: a }
    );
  }
  "undefined" != typeof module && (e.CalculateAnimationSpecs = s),
    ...
    (e.CalculateAuto = function(e, t) {
      ...
      return (
        (e.style[t] =
          ((o =
            "height" === t
              ? ((n = e.clientHeight), (e.style[t] = "auto"), e.clientHeight)
              : ((n = e.clientWidth), (e.style[t] = "auto"), e.clientWidth)),
          n + "px")),
        parseInt(o)
      );
    }),
    ...
    (e.Run = function(i) {
      var l = i.element,
        e = i.speed || 250;
      l.length === undefined && (l = [l]),
        "function" != typeof i.callback && (i.callback = function() {}),
        (l[0].AUinteration = 0),
        (l[0].AUinterations = l.length);
      for (var t = 0; t < l.length; t++) {
        ...
        var r = s(o, a, e),
          c = o;
        r.stepSize < 0
          ? (n.AUtoggleState = "closing")
          : 0 < r.stepSize && (n.AUtoggleState = "opening"),
          (function(e, t, n, o, a) {
            e.AUanimation = setInterval(function() {
              if (t === a || 0 === o.steps) {
                if (
                  (f.animate.Stop(e),
                  (e.style[i.property] = a + "px"),
                  (e.AUtoggleState = ""),
                  l[0].AUinteration++,
                  "auto" === i.endSize && (e.style[i.property] = ""),
                  l[0].AUinteration >= l[0].AUinterations)
                )
                  return i.callback();
    ...
    (e.Toggle = function(t) {
      ...
      for (var l = 0; l < n.length; l++) {
        ...
        if (p === a || "closing" === c.AUtoggleState)
          (r = i), (s = "opening"), (u = "open");
        else {
          if (p === a && "opening" !== c.AUtoggleState)
            throw new Error(
...
!(function(h) {
  ...
  function U(e, t, n, o) {
    if ("opening" === t || "open" === t)
      ...
      (a = o || "au-main-nav__content--open"),
        (i = n || "au-main-nav__content--closed");
    var l, r, c, s;
    (s = a),
      (c = e).classList
        ? c.classList.remove(s)
  ...
  function _(t, e, n) {
    ...
    return t.addEventListener
      ? (t.addEventListener(e, o, !1), { element: t, handler: o, event: e })
      : (t.attachEvent("on" + e, a), { element: t, handler: a, event: e });
  }
  function w(e) {
